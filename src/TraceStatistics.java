...
import ccp.experiments.ess.AutocorrelationSignatureLogExperiment;
...
public class TraceStatistics {
    ...
    private void analyseCorrelationContinuous(double[] values, long stepSize) {
        ...
        if (AutocorrelationSignatureLogExperiment.printAutocorrelationSignature) {
            System.out.println(Arrays.toString(gammaStat));
        }
